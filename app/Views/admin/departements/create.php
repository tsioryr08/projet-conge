...
<div class="app-wrap">
  ...
  <div class="main">
    <div class="topbar">
      <div>
        <div class="topbar-title">Créer un département</div>
        <div class="topbar-breadcrumb"><a href="/admin">Admin</a> <i class="bi bi-chevron-right"></i> <a href="/admin/departements">Départements</a> <i class="bi bi-chevron-right"></i> Créer</div>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="data-card" style="max-width:600px">
        <form method="post" action="/admin/departements">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <textarea name="description" class="f-input" style="resize:vertical;height:100px"><?= old('description') ?></textarea>
          </div>
