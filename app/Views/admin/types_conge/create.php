...
<div class="app-wrap">
  ...
  <div class="main">
    <div class="topbar">
      <div>
        <div class="topbar-title">Créer un type de congé</div>
        <div class="topbar-breadcrumb"><a href="/admin">Admin</a> <i class="bi bi-chevron-right"></i> <a href="/admin/types_conge">Types de congé</a> <i class="bi bi-chevron-right"></i> Créer</div>
      </div>
    </div>
    ...
    <div class="content">
      ...
      <div class="data-card" style="max-width:600px">
        <form method="post" action="/admin/types_conge">
          <?= csrf_field() ?>

          <div class="form-group">
            <label class="f-label">Libellé *</label>
            <input type="text" name="libelle" class="f-input" required value="<?= old('libelle') ?>">
          </div>

          <div class="form-group">
            <label class="f-label">Jours annuels *</label>
            <input type="number" name="jours_annuels" class="f-input" required min="1" value="<?= old('jours_annuels') ?>">
          </div>
